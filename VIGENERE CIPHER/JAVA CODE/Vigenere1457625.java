...
public class Vigenere1457625 {
	 ...
	 * @see Vigenere1457625#calcIC(int[])
	 */
	 ...
	 * @return the Index of Coincidence
	 * @see Vigenere1457625#calcIC(String)
	 */
	 ...
	 * 3-character {@link Substring1457625}s, and counts the number of occurances of
	 ...
	 * @see Vigenere1457625#estimateKeyLength(HashMap, int, int)
	 */
	public static int kasiski(String text, int minKeyLength, int maxKeyLength) {
		HashMap<String, Substring1457625> substringMap = new HashMap<String, Substring1457625>();
		text = format(text);
		String sub;
		...
		for (int i = 0; i < text.length() - 2; i++) {
			...
			if (substringMap.containsKey(sub)) {
				...
				substringMap.put(sub, new Substring1457625(sub, i));
			}
		}

		// Convert HashMap to ArrayList for working with the values
		ArrayList<Substring1457625> substrings = new ArrayList<Substring1457625>(
				substringMap.values());

		// Remove all substrings with only single occurrence
		substrings = Substring1457625.removeSingleOccurrenceSubstrings(substrings);
		...
		for (Substring1457625 substr : substrings) {
	...
	/**
	 * Uses a list of {@link Substring1457625} occurences found through the Kasiski
	 ...
	 *         with occurrences
	 * @see Vigenere1457625#kasiski(String, int, int)
	 */
