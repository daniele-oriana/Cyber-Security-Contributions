...
public class Substring1457625 {
	 ...
	 */
	public Substring1457625(String msg, int pos) {
		message = msg;
	 ...
	 */
	public static ArrayList<Substring1457625> removeSingleOccurrenceSubstrings(
			ArrayList<Substring1457625> substrings) {
		Iterator<Substring1457625> it = substrings.iterator();
		while (it.hasNext()) {
			Substring1457625 substr = it.next();
